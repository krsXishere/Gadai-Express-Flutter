...
class MobileBarangPage extends StatefulWidget {
  const MobileBarangPage({super.key});

  @override
  State<MobileBarangPage> createState() => _MobileBarangPageState();
}

class _MobileBarangPageState extends State<MobileBarangPage> {
